...
$pdk.plugin.ratings.version = "0.1.16-05-03_11_58";
/* 
...
$pdk.plugin.Ratings = $pdk.extend(function(){},{
	constructor: function() {
        ...
        this.overlay.className = "tpRatingsImage";
...
if(tpController && tpController.plugInLoaded) {
	tpController.plugInLoaded(_tprp, _tprp.overlay);
}