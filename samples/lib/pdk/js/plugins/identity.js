...
$pdk.plugin.Identity = $pdk.extend(function(){},
{
    ...
    identityServiceUrl: "https://euid.<mpx>", //theplatform.com",
    ...
    initialize : function(lo){
        ...
        {
            this.identityServiceUrl = this.identityServiceUrl.replace("<mpx>", this.controller.getProperty("mpx"));
        }
    ...
    {
        this.prompting = false;
        this.controller.endRelease();
        this.controller.callFunction("nextRelease", [false, true]);
    },
